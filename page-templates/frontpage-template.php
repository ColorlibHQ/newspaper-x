...
<div class="col-md-12">
	...
	<section class="newspaperx-content-area">
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 newspaperx-content">
				<?php
			...
			<aside class="col-lg-4 col-md-4 col-sm-4 newspaperx-sidebar hidden-sm hidden-xs">
				<div class="newspaperx-blog-sidebar">
					<?php
					if ( is_active_sidebar( 'blog-sidebar' ) ) {
						dynamic_sidebar( 'blog-sidebar' );
					} else {
						the_widget( 'WP_Widget_Search', sprintf( 'title=%s', __( 'Search', 'newspaper-x' ) ) );
					}
					?>
				</div> <!--/.newspaperx-blog-sidebar-->
			</aside><!--/.col-lg-4-->
		</div><!--/.row-->
	</section><!--/section-->

	<section class="newspaperx-after-content-area">
		<div class="row">
			<div class="col-xs-12 newspaperx-after-content-sidebar">
				<?php
