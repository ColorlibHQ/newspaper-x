...
class Widget_NewspaperX_Recent extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'NewspaperX_Recent', // Base ID
			__( 'Newspaper X Recent Posts', 'newspaper-x' ), // Name
			array( 'description' => __( 'Recent Posts!', 'newspaper-x' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$before_widget = str_replace( 'class="', 'class="newspaperx-recent-posts ', $before_widget );
		echo $before_widget;
