...
class Widget_Bugle_Contact extends WP_Widget {
	/**
	 * @internal
	 */
	public function __construct() {
		parent::__construct(
			'Bugle_Contact', // Base ID
			__( 'Bugle Contact Widget', 'bugle' ), // Name
			array( 'description' => __( 'Bugle Contact Widget', 'bugle' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $instance ) ) {
			$instance = array(
				...
				'email'         => esc_html( 'ensign@contact.com' ),
		...
		$before_widget = str_replace( 'class="', 'class="bugle-contact-widget ', $before_widget );
		echo $before_widget;
