...
class Newspaper_X_Welcome {
	...
	public function newspaper_x_welcome_admin_notice() {
		...
		<div class="updated notice is-dismissible">
			<p><?php echo sprintf( esc_html__( 'Welcome! Thank you for choosing Newspaper X! To fully take advantage of the best our theme can offer please make sure you visit our %1$s welcome page %2$s.', 'newspaper-x' ), '<a href="' . esc_url( admin_url( 'themes.php?page=newspaper-x-welcome' ) ) . '">', '</a>' ); ?></p>
	...
	public function newspaper_x_welcome_screen() {
		...
		<div class="wrap about-wrap epsilon-wrap">
			...
			<h2 class="nav-tab-wrapper wp-clearfix">
				...
				<a href="<?php echo esc_url( admin_url( 'themes.php?page=newspaper-x-welcome&tab=changelog' ) ); ?>"
				   class="nav-tab <?php echo $active_tab == 'changelog' ? 'nav-tab-active' : ''; ?> "><?php echo esc_html__( 'Changelog', 'newspaper-x' ); ?></a>
			</h2>
