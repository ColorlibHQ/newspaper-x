...
function newspaper_x_scripts() {
	 ...
	 * Adsense loader
	 */
	wp_enqueue_script( 'newspaper-x-adsense-loader', get_template_directory_uri() . '/assets/vendors/adsenseloader/jquery.adsenseloader.js', array( 'jquery' ), $newspaper_x['Version'], true );
	...
	wp_localize_script( 'newspaper-x-functions', 'WPUrls', array(
		'siteurl' => esc_js( get_option( 'siteurl' ) ),
		'theme'   => esc_js( get_template_directory_uri() ),
