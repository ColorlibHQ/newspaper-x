...
class Widget_Newspaper_About extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'newspaper_x_widget_about', esc_html__( 'Newspaper X - About me', 'newspaper-x' ), array(
			'classname'                   => 'newspaper_x_widgets',
			'description'                 => esc_html__( 'Layout consists ... .', 'newspaper-x' ),
	...
	public function widget( $args, $instance ) {
		...
		$filepath = get_template_directory() . '/inc/widgets/about_me/layouts/default.php';
